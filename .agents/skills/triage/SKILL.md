...
1. Read `AGENTS.md` — the project's master guidance file. Understand the tech
   stack, architecture rules, conventions, spec locations, and constraints.
2. Read the spec overview index (referenced in AGENTS.md) to understand existing
...
3. Read 2-3 existing specs from the project's spec directory to learn the exact
   ...
   match it precisely.
4. If architecture or design docs exist (referenced in AGENTS.md), skim them to
