...
var PresetDashboard = Preset{
	...
	Grid: []Row{
		{HeightWeight: 2, MinHeight: 9, Cells: []Cell{{PaneID: PaneNowPlaying, WidthWeight: 1}}},
...
var PresetLibrary = Preset{
	...
	Grid: []Row{
		{HeightWeight: 1, MinHeight: 9, Cells: []Cell{{PaneID: PaneNowPlaying, WidthWeight: 1}}},
...
var PresetStats = Preset{
	...
	Grid: []Row{
		{HeightWeight: 2, MinHeight: 9, Cells: []Cell{
