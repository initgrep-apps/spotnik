...
## [0.1.1](https://github.com/initgrep-apps/spotnik/compare/v0.1.0...v0.1.1) (2026-07-17)


### Bug Fixes

* **api:** html-escape OAuth callback error parameter ([15d99fc](https://github.com/initgrep-apps/spotnik/commit/15d99fc539ee17d9eb01b6ace3da2452f2e471be))
...
### Added
- Like/unlike tracks across all panes
- Responsive pane columns
- Podcast support with viewport-based episode details
