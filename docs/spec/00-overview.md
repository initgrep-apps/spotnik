...
| 25 | NowPlaying Controls Polish | `features/25-nowplaying-controls-polish/` | open | 122, 123 | Repeat-track superscript icon (↻¹), volume 1% steps, partial-block bar rendering |
