...
| 23 | User Profile & Subscription Awareness | `features/23-user-profile-subscription/` | open | 114 (done), 115, 116 | Expand UserProfile with tier/country, profile overlay (`u` key), header chip, Premium gate for playback keys and device transfer, splash notice |
