...
| 20 | Pane Content Design Language | `features/20-pane-content-design/` | done | 245 ✓, 246 ✓, 247 ✓, 248 ✓, 249 ✓, 250 ✓, 251 ✓, 252 ✓ | Unified design system: remove PlayingIndex dead code, remove # column, fix icon positions, responsive column priority, optimized headers, consistent EmptyStates |
...
*Last updated: 2026-06-18 — feature 20 spec created: stories 245–252 (Pane Content Design Language)*
