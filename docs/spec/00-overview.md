...
| 18 | Search Overlay Redesign | `features/18-search-redesign/` | open | 81 | Wide tabbed search overlay with rich metadata columns, per-section counts, contextual help bar |
