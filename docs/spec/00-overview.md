...
| 18 | Search Overlay Redesign | `features/18-search-redesign/` | open | 81, 82 | Wide tabbed search overlay with rich metadata columns, per-tab theme colors, contextual help bar |
