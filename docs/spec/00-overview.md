...
| 15 | Error Resilience & Universal Polling | `features/15-error-resilience/` | in-progress | 199 ✓, 200 ✓, 201–203 | Universal tick-driven polling for all data panes, per-pane exponential backoff, silent failure fixes, overlay self-sufficiency, auth error mapping |
