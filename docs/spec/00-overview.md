...
| 25 | NowPlaying Controls Polish | `features/25-nowplaying-controls-polish/` | in-progress | 122 (done), 123 | Repeat-track superscript icon (↻¹), volume 1% steps, partial-block bar rendering |
...
*Last updated: 2026-04-11* (added feature 25)
