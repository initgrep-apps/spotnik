...
| 16 | Vivid Theme System | `features/16-vivid-themes/` | in-progress | 70, 71, 72, 73, 74, 75, 77, 78 | Config-driven TOML themes, colorful borders, per-column colors, 6 new themes, runtime switcher overlay |
| 17 | Bootstrap | `features/17-bootstrap/` | open | 76 | First-launch config bootstrap, embedded client ID via ldflags |
