...
| 22 | Developer Foundations | `features/22-developer-foundations/` | open | 109 (done), 110, 111 | Onboarding docs, test infra, StateReader interface, file splits, BasePane pattern, RebuildTableTheme helper, auth client fix |
