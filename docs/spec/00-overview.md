...
| 03 | Playback & NowPlaying | `features/03-playback/` | done | 03, 11, 36, 45, 58–60, 105–107, 118–125, 197–198 | Transport controls, NowPlaying display, visualizer |
...
| 15 | Error Resilience & Universal Polling | `features/15-error-resilience/` | in-progress | 199 ✓, 200 ✓, 201 ✓, 202–203 | Universal tick-driven polling for all data panes, per-pane exponential backoff, silent failure fixes, overlay self-sufficiency, auth error mapping |
