...
| 19 | Search Redesign | `features/19-search-redesign/` | done | 81, 82, 83, 84, 85, 86 | Full-screen search overlay with tabs, prefetch pagination, bubbles/list delegate, prefix autocomplete |
