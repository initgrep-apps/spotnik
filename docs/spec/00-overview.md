...
| 17 | Album Art & Responsive NowPlaying | `features/17-album-art/` | done | 214 ✓, 215 ✓, 216 ✓, 217 ✓ | Pixelated album art via pixterm, 3-tier responsive NowPlaying layout (base/mid/full), LayoutManager MinHeight, Stats page fix |
