...
| 09 | Auth, Bootstrap & User Profile | `features/09-auth-and-profile/` | in-progress | 02, 17, 76, 79*, 80, 114–117, 134–140 | PKCE OAuth, token refresh, config-first client ID, TUI onboarding flow, auth CLI subcommands, profile logout/forget |
