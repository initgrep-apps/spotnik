...
| 20 | Pane Content Design Language | `features/20-pane-content-design/` | done | 245 ✓, 246 ✓, 247 ✓, 248 ✓, 249 ✓, 250 ✓, 251 ✓, 252 ✓, 253 ✓, 254 ✓ | Unified design system + fix stories: revert # column removal, tune responsive flex factors |
