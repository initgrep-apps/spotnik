...
| 20 | Pane Content Design Language | `features/20-pane-content-design/` | in-progress | 245 ✓, 246 ✓, 247 ✓, 248 ✓, 249 ✓, 250 ✓, 251 ✓, 252 ✓, 253, 254 | Unified design system + fix stories: revert # column removal, tune responsive flex factors |
...
*Last updated: 2026-06-18 — feature 20: fix stories 253, 254 added (revert # column, tune flex factors)*
