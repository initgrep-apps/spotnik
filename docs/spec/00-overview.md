...
| 26 | Optimistic Playback Updates | `features/26-optimistic-playback/` | done | 124 (done), 125 (done), 126 (done) | Eliminate ~500ms–1s UI lag on playback controls by writing predicted state to store immediately on key press |
...
*Last updated: 2026-04-12* (feature 26 fully done: stories 124, 125, 126 complete)
