...
| 21 | End-to-End Test Infrastructure | `features/21-test-infrastructure/` | open | 256–261 ✓, 262–266 | Component golden-file snapshots + integration flow tests using `teatest`; testing pyramid gains View() regression and multi-step flow layers |
