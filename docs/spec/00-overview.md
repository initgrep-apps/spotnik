...
| 18 | Search Overlay Redesign | `features/18-search-redesign/` | in-progress | 81, 82, 83, 84, 85, 86, 87, 88, 89 | Wide tabbed search overlay with rich metadata columns, per-tab theme colors, contextual help bar, pagination |
