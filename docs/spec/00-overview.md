...
| 21 | End-to-End Test Infrastructure | `features/21-test-infrastructure/` | open | 256 ✓, 257 ✓, 258–266 | Component golden-file snapshots + integration flow tests using `teatest`; testing pyramid gains View() regression and multi-step flow layers |
...
*Last updated: 2026-06-26 — added feature 21 (End-to-End Test Infrastructure)*
