...
| 26 | Playback Control Correctness | `features/26-playback-correctness/` | open | 124, 125 | Request-aware dedup (Interactive GETs skip inflight map), remove gateway debounce |
