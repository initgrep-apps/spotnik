...
| 11 | CI/CD & Release | `features/11-cicd/` | done | 57, 128–133, 194, 276 | GitHub Actions, GoReleaser, release-please, multi-platform distribution, curl/PS1 installer scripts, least-privilege workflow permissions |
