...
| 19 | Player Page Unification | `features/19-player-page-unification/` | open | 233 ✓, 234 ✓, 235 ✓, 236 ✓, 238 ✓, 239 ✓, 240 ✓, 241 ✓, 242 ✓, 243 ✓, 244 | Unify Music+Podcasts into single Player page, content-aware NowPlaying, FollowedShows drill-down, Queue mixed content, auto-switch presets, visibility-gated polling, Episode Details overlay |
...
*Last updated: 2026-06-17 — added story 244 (viewport-based Episode Details scrolling) to feature 19*
